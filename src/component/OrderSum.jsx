...
const OrderSum = () => {
  return (
    <React.Fragment>
      ...
      >
        <p className="font-weight-bold p-2 ml-4 mt-3">
        ...
        <div className="cart d-flex ">
          ...
          <div className="head ml-5">
            ...
            <h2 style={{ marginLeft: 'px', marginTop: '30px' }}>
              <b>#2,800.00</b>
            </h2>
            ...
            <button
              ...
              style={{ width: '200px', borderRadius: '10px', height: '40px' }}
            >
              <p
                className="writ"
                style={{
          ...
          <div className="cart1 d-flex ">
            ...
            <div className="nums" style={{ marginTop: '20px' }}>
              ...
              <div className="d-flex">
                <div className="total" style={{ marginLeft: '-100px' }}>
                  <b> Total</b>
                </div>
                <div className="nom" style={{ marginLeft: '260px' }}>
                  <b>#2,800.00</b>
                </div>
              </div>
            </div>
        ...
        ></p>
        <div className="d-flex">
          <div className="total" style={{ marginLeft: '30px' }}>
            <b>SHIPPING ADRESS</b>
          </div>
          <div className="nom" style={{ marginLeft: '550px' }}>
            <b>CHECKOUT</b>
          </div>
        </div>
        <p
