  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <div className="cart d-flex mt-5">
          ...
          <div className="head ml-5">
            ...
            <p className="font-weight-normal mt-3">
              100% Cotton 12 Pieces Of Mens Boxer{' '}
            </p>
              ...
              <div className="butto mt-3">
                ...
                >
                  <img
                    ...
                    alt=""
                    className="app"
                    style={{ width: '17px', marginLeft: '-80px' }}
                  />
                  <p
                    className="pen"
          ...
          <div
            className="vborder"
            style={{ borderLeft: '1px solid lightgray', marginLeft: '30px' }}
          ></div>
          <div className="subparent">
            ...
            <div className="d-flex">
              <div className="but1">
                <button
                  type="btn"
                  className="btn bg-danger btn-outline-light ml-4 mt-2"
              ...
              <div className="but1">
                <button
                  type="btn"
                  className="btn bg-danger btn-outline-light ml-3 mt-2"
                  style={{ width: '40px', height: '40px' }}
                >
                  <p>-</p>
                </button>
          ...
          <div className="subpar">
            ...
            <h2 style={{ marginLeft: '60px', marginTop: '30px' }}>
              <b>#2,800.00</b>
            </h2>
          </div>
        </div>
        ...
        ></p>
        <h5 className="trab" style={{ marginLeft: '600px' }}>
          <b>CART TOTALS</b>
        </h5>
        <div className="cart1 d-flex mt-5">
          <div className="catpa" style={{ marginTop: '-30px' }}>
            ...
            <button
              type="btn"
              className="btn bg-light btn-outline-danger  mt-2"
              style={{ width: '200px', height: '40px', marginLeft: '600px' }}
            >
              continue shopping
            </button>
          </div>
          <div className="nums" style={{ marginTop: '-30px' }}>
            ...
            <button
              type="btn"
              className="btn bg-danger btn-outline-light  mt-2"
