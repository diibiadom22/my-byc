    ...
    <React.Fragment>
      ...
      <div>
        <h4 className="text-center">
          <b>How important are shoes in your style?</b>
        </h4>
      </div>
      <div className="para">
        <p
        ...
        >
          ...
          sint. Velit officia duis enim velit mollit. Exercitation veniam
          consequat
          <br /> sunt nostrud ametAmet minim mollit non deserunt ullamco est sit
          ...
          duis enim velit
          <br /> mollit. Exercitation veniam consequat sunt nostrud ametAmet
          minim mollit non deserunt ullamco est sit aliqua dolor do amet sint.
          Velit officia consequat
          <br /> duis enim velit mollit. Exercitation veniam consequat sunt
          ...
          consequat sunt nostrud ametAmet minim mollit non deserunt ullamco est
          sit aliqua dolor do{' '}
        </p>
      </div>
      <div className="ground ">
        <img
          ...
          alt=""
          className="w-100"
          style={{ height: '682px', marginLeft: '14px', marginTop: '50px' }}
        />
      </div>
      <p style={{ marginLeft: '95px', marginTop: '50px' }}>
        Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet
        ...
        aliqua dolor do amet sint. Velit officia consequat duis enim velit
        mollit. Exercitation
        <br /> veniam consequat sunt nostrud amet..Amet minim mollit non
        deserunt ullamco est sit aliqua dolor do amet sint. Velit officia
        consequat duis enim velit
        <br /> Amet minim mollit non deserunt ullamco est sit aliqua dolor do
        ...
        enim velit
        <br /> mollit. Exercitation veniam consequat sunt nostrud ametAmet minim
        ...
        consequat sunt nostrud ametAmet minim mollit non deserunt ullamco est
        sit aliqua dolor
        <br /> doAmet minim mollit non deserunt ullamco est sit aliqua dolor do
        amet sint. Velit officia consequat duis enim velit mollit. Exercitation
        veniam consequat
        <br /> sunt nostrud ametAmet minim mollit non deserunt ullamco est sit
        aliqua dolor do amet sint. Velit officia consequat duis enim velit
      ...
      <div
        ...
        style={{ marginTop: '100px', marginLeft: '530px' }}
      >
        <ul class="pagination">
          <li class="page-item ">
